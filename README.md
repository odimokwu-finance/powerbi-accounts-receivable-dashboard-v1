...
![Aging Chart](Screenshots/02-Aging-Chart.png)

### Payment Status Donut
This screenshot shows the payment status distribution of outstanding balances.

![Payment Status Donut](Screenshots/03-Payment-Status-Donut.png)
...
![Accounts Receivable Invoice Detail](Screenshots/04-Accounts-Receivable-Invoice-Detail.png)
